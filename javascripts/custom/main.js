      ...
      $('.team-carousel-item').click(function (evt) {
        ...
        switch (imgClass) {
          ...
          case 'team-01-carousel-item-04':
            ...
            var divA = '<h1>Armando Carvajal & Victor Perera</h1><h4>DESARROLLO WEB</h4><h3>"Siempre innovando y hacia adelante"<br><div><a href="https://www.instagram.com/armandoecr/?hl=es-la" target="_blank"><i class="fab fa-instagram"></i></a><a href="https://www.facebook.com/armando.carvajal.142" target="_blank"><i style="font-size: 2.4rem;" class="fab fa-facebook-f"></i></a></div></h3>'
